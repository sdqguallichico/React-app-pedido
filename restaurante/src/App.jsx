...
import ReservationPage from "./components/ReservationPage"; // Importa el nuevo componente
...
function App() {
  ...
  return (
    <Router>
      <Routes>
        {/* Ruta independiente para la página de reservas */}
        <Route path="/reservas" element={<ReservationPage />} />
        
        <Route path="/reservas/pedido" element={<ReservationForm />} />
        <Route
          path="*"
          element={
            <Layout>
